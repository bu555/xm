...
<div class="con-nav">
            ...
            <div class="login-status">
                ...
                <div class="user-control" v-if="!$store.state.userName">
                    ...
                    <router-link to="/user/register">
                        <span style="margin-left:12px;">注册</span>
                    </router-link>
                </div>
    ...
    <!--tab导航条-->
    <div class="tab-nav" v-if="!isUserPath">
        <el-tabs type="card" v-model="activeName"   @tab-click="handleClick" style="margin-top:5px">
            <!--动态生成tab导航-->
            <el-tab-pane v-for="(v,i) in $t(tObj[activeTab])" :key="i" :label="v" :name="activeTab+'-'+(i+1)"></el-tab-pane>
        </el-tabs>
    </div>
  </div>
</template>
