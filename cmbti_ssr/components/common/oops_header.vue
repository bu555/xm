    ...
    <div class="oops_header_content">
      <div class="container head1">
        <div class="oops_title">
          <div class="oops_title_left" @click="close_nav_down" style="cursor: pointer">
            <router-link to="/">
            <img :src="$store.state.logo_style>768?'/static/img/logo.png':'/static/img/logo_phone.png'" alt="">
            </router-link>
          </div>
          <!--右侧登录、登录信息显示模块-->
...
import headerLogin from "./oops_header_login";
...
export default {
  ...
  created() {
    this.logo_boolean = $(window).width()
