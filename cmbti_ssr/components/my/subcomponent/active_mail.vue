<template>
  <div class="m-modify-mail" v-loading="loading">
           ...
           <div class="m-step">
            ...
            <div v-if="currentStep==1">
                <div class="form-group">
                    <label for="oldEmail">郵箱</label>
                    <input type="text" class="form-control" id="oldEmail" placeholder="郵箱" v-model="step1.name" disabled>
                </div>
