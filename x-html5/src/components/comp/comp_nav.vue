<template>
    <div class="comp-nav h5-bx">
	<ul id="menu">
    	<li class="item"><a href="#">Home</a></li>
		<li class="item"><a href="#" >Services</a></li>
		<li class="item"><a href="#" >About</a></li>
		<li class="item"><a href="#" >Links</a></li>
		<li class="item active"><a href="#" >Portfolio</a></li>
		<li class="item"><a href="#" >Consulting</a></li>
...
.comp-nav {
	// background: -webkit-linear-gradient(top, #F68344 0.00%, #98370F 60.00%);background: linear-gradient(top, #F68344 0.00%, #98370F 60.00%);
